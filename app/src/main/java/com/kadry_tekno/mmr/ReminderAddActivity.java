...
public class ReminderAddActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFAB3 = (FloatingActionButton) findViewById(R.id.motor);
        mFAB4 = (FloatingActionButton) findViewById(R.id.mobil);
    ...
    // On clicking the active button FAB MOTOR
    public void selectFab3(View v) {
        mFAB3 = (FloatingActionButton) findViewById(R.id.motor);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0)
                    mTitleText.setError("Reminder Title tidak boleh kosong!!!");
            ...
            case R.id.discard_reminder:
                Toast.makeText(getApplicationContext(), "Dibatalkan",
                        Toast.LENGTH_SHORT).show();
